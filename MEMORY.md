...
- The card color is `#382f63` to `#231b46` (dark indigo/purple gradient) with a thin white/silver border.
- The branding logo is placed at the bottom-left of the card.
- The ID card container and "Save to Contacts" button are grouped directly on the body element with a close vertical spacing gap (`gap-5`), positioning the button naturally right underneath the card.
